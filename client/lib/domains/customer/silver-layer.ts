...
export const customerIdentifierSilver: SilverTableDefinition = {
  ...
  schema: "CORE_CUSTOMERS",
  description: "Customer government identifiers with encryption and validation",
  businessKey: "customer_number",
  ...
  columns: [
    { name: "customer_identifer_sk", dataType: "NUMBER(38,0)", nullable: false, businessMeaning: "System-generated number assigned to the customer record", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A" } },
    { name: "customer_number_fk", dataType: "NUMBER(38,0)", nullable: true, businessMeaning: "Foreign key referencing from surrogate key of customer Attribute", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "Lookup to DIM_CUSTOMER_ATTRIBUTE" } },
    { name: "customer_number", dataType: "VARCHAR(16777216)", nullable: false, businessMeaning: "System-generated number for CUSTOMER record", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "CUSTOMER_NUMBER" } },
    { name: "driving_license_number", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Encrypted Driving License Number", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "DRIVING_LICENSE_NUMBER" }, piiClassification: "HIGH", encryptionMethod: "AES_256" },
    { name: "tax_identification_number", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Encrypted Tax ID Number", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "TAX_IDENTIFICATION_NUMBER" }, piiClassification: "HIGH", encryptionMethod: "AES_256" },
    { name: "tax_identification_last_4", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Last 4 digits of the Tax ID", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "TAX_IDENTIFICATION_LAST_4" }, piiClassification: "MEDIUM" },
    { name: "passport_number", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Encrypted Passport Number", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "PASSPORT_NUMBER" }, piiClassification: "HIGH", encryptionMethod: "AES_256" },
    { name: "alien_registration", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Alien registration number", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "ALIEN_REGISTRATION" } },
    { name: "amish_cust_no_id", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Amish ID Number", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "AMISH_CUST_NO_ID" } },
    { name: "certificate_of_registration_ivu", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "CERTIFICATE OF REGISTRATION -IVU", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "CERTIFICATE_OF_REGISTRATION_IVU" } },
    { name: "disabled_elderly_no_id", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Disabled or Elderly ID", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "DISABLED_ELDERLY_NO_ID" } },
    { name: "foreign_entity_no_id", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Foreign entity Id", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "FOREIGN_ENTITY_NO_ID" } },
    { name: "government_agency_no_id", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Government Agency Id", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "GOVERNMENT_AGENCY_NO_ID" } },
    { name: "incorporation_register", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Icorporation Id", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "INCORPORATION_REGISTER" } },
    { name: "license", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "License", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "LICENSE" } },
    { name: "military_id", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Military Id", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "MILITARY_ID" } },
    { name: "minor", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "MINOR Id", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "MINOR" } },
    { name: "other_identification", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Other Identification id", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "OTHER_IDENTIFICATION" } },
    { name: "state_id", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "State Id", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "STATE_ID" } },
    { name: "vi_bus_license", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "VI Bus License Id", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "VI_BUS_LICENSE" } },
    { name: "row_hash", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Hash value of Business Columns", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "MD5 hash" } },
    { name: "effective_start_date", dataType: "DATE", nullable: true, businessMeaning: "Indicates date when record got Active", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "SCD Type 2 logic" } },
    { name: "effective_end_date", dataType: "DATE", nullable: true, businessMeaning: "Indicates date when record got Inactive", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "SCD Type 2 logic" } },
    { name: "business_date", dataType: "DATE", nullable: true, businessMeaning: "Date when the record was created in business", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "BUSINESS_DATE" } },
    { name: "record_date", dataType: "DATE", nullable: true, businessMeaning: "Date when the record was Extracted", sourceMapping: { bronzeTable: "bronze.customer_identifiers", bronzeColumn: "RECORD_DATE" } },
    { name: "record_flag", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Indicates whether record is 'current' or 'history'", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "SCD Type 2 logic" } },
    { name: "insert_by", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "User ID used for the pipeline execution", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "System generated" } },
    { name: "insert_dt", dataType: "TIMESTAMP_NTZ(9)", nullable: true, businessMeaning: "Datetime when record is inserted", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "System generated" } },
    { name: "last_modified_by", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "User ID used for the pipeline Modified", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "System generated" } },
...
export const customerNameSilver: SilverTableDefinition = {
  ...
  schema: "CORE_CUSTOMERS",
  description: "Customer name attributes with SCD Type 2",
  businessKey: "customer_number",
  surrogatePrimaryKey: "customer_sk",
  ...
  columns: [
    ...
    { name: "customer_number_fk", dataType: "NUMBER(38,0)", nullable: true, businessMeaning: "Foreign key referencing from surrogate key of customer Attribute", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "Lookup to DIM_CUSTOMER_ATTRIBUTE" } },
    { name: "customer_number", dataType: "VARCHAR(16777216)", nullable: false, businessMeaning: "System-generated number to the CUSTOMER record", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "CUSTOMER_NUMBER" } },
    { name: "first_name", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "CUSTOMER's first name", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "FIRST_NAME" }, piiClassification: "HIGH" },
    { name: "last_name", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "CUSTOMER's last name", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "LAST_NAME" }, piiClassification: "HIGH" },
    { name: "middle_name_1", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "CUSTOMER's middle name or initial", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "MIDDLE_NAME_1" }, piiClassification: "HIGH" },
    { name: "middle_name_2", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "CUSTOMER's middle name or initial", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "MIDDLE_NAME_2" }, piiClassification: "HIGH" },
    { name: "customer_name", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "CUSTOMER's full name", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "CUSTOMER_NAME" }, piiClassification: "HIGH" },
    { name: "customer_type_code", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Identifies the type of CUSTOMER - Individual / Business", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "CUSTOMER_TYPE_CODE" } },
    { name: "customer_type_desc", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Identifies the type of CUSTOMER - Individual / Business", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "CUSTOMER_TYPE_DESC" } },
    { name: "effective_start_date", dataType: "DATE", nullable: true, businessMeaning: "Indicates date when record got Active", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "SCD Type 2 logic" } },
    { name: "effective_end_date", dataType: "DATE", nullable: true, businessMeaning: "Indicates date when record got Inactive", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "SCD Type 2 logic" } },
    { name: "record_flag", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Indicates whether record is 'current' or 'history'", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "SCD Type 2 logic" } },
    { name: "business_date", dataType: "DATE", nullable: true, businessMeaning: "Date when the record was created in business", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "BUSINESS_DATE" } },
    { name: "record_date", dataType: "DATE", nullable: true, businessMeaning: "Date when the record was Extracted", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "RECORD_DATE" } },
    { name: "row_hash", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Hash value of Business Columns", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "MD5 hash" } },
    { name: "insert_by", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "User ID used for the pipeline execution", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "System generated" } },
    { name: "insert_dt", dataType: "TIMESTAMP_NTZ(9)", nullable: true, businessMeaning: "Datetime when record is inserted", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "System generated" } },
    { name: "last_modified_by", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "User ID used for the pipeline Modified", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "System generated" } },
...
export const customerAddressSilver: SilverTableDefinition = {
  ...
  schema: "CORE_CUSTOMERS",
  description: "Customer address with USPS standardization and SCD Type 2",
  businessKey: "customer_number",
  ...
  grain: "One row per customer",
  columns: [
    { name: "customer_address_sk", dataType: "NUMBER(38,0)", nullable: false, businessMeaning: "System generated SK", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A" } },
    { name: "customer_number_fk", dataType: "NUMBER(38,0)", nullable: true, businessMeaning: "Foreign key referencing from surrogate key of customer Attribute", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "Lookup to DIM_CUSTOMER_ATTRIBUTE" } },
    { name: "customer_number", dataType: "VARCHAR(16777216)", nullable: false, businessMeaning: "A unique identifier assigned to each customer", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "CUSTOMER_NUMBER" } },
    { name: "bank_number", dataType: "NUMBER(38,0)", nullable: true, businessMeaning: "Unique Key for each Bank record", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "BANK_NUMBER" }, piiClassification: "HIGH" },
    { name: "address_line_1", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Physical address of the CUSTOMER : Line 1 : House number", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "ADDRESS_LINE_1" }, piiClassification: "HIGH" },
    { name: "address_line_2", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Physical address of the CUSTOMER : Line 2: Street name /no", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "ADDRESS_LINE_2" }, piiClassification: "HIGH" },
    { name: "city", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "City of residence of the CUSTOMER", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "CITY" }, piiClassification: "MEDIUM" },
    { name: "state", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "State of residence of the CUSTOMER", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "STATE" }, piiClassification: "MEDIUM" },
    { name: "zip_code_1", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "ZIP code fo the CUSTOMER address", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "ZIP_CODE_1" }, piiClassification: "MEDIUM" },
    { name: "zip_code_2", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "ZIP code fo the CUSTOMER address", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "ZIP_CODE_2" }, piiClassification: "MEDIUM" },
    { name: "country_code", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Identifies the country associated with the address", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "COUNTRY_CODE" }, piiClassification: "MEDIUM" },
    { name: "country_name", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Name of the country associated with the address", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "COUNTRY_NAME" }, piiClassification: "MEDIUM" },
    { name: "address_type", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Address type : Home /Communication etc.", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "ADDRESS_TYPE" }, piiClassification: "MEDIUM" },
    { name: "row_hash", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Hash value of Business Columns", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "MD5 hash" } },
    { name: "business_date", dataType: "DATE", nullable: true, businessMeaning: "Date when the record was created in business", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "BUSINESS_DATE" } },
    { name: "record_date", dataType: "DATE", nullable: true, businessMeaning: "Date when the record was Extracted", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "RECORD_DATE" } },
    { name: "effective_start_date", dataType: "DATE", nullable: true, businessMeaning: "Indicates date when record got Active", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "SCD Type 2 logic" } },
...
export const customerContactSilver: SilverTableDefinition = {
  ...
  schema: "CORE_CUSTOMERS",
  description: "Customer contact phone numbers with SCD Type 2",
  businessKey: "customer_number",
  ...
  grain: "One row per customer",
  columns: [
    { name: "customer_contact_sk", dataType: "NUMBER(38,0)", nullable: false, businessMeaning: "Primary key for CUSTOMER contact", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A" } },
    { name: "customer_number_fk", dataType: "NUMBER(38,0)", nullable: true, businessMeaning: "Foreign key referencing from surrogate key of customer Attribute", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "Lookup to DIM_CUSTOMER_ATTRIBUTE" } },
    { name: "customer_number", dataType: "VARCHAR(16777216)", nullable: false, businessMeaning: "A unique identifier assigned to each customer", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "CUSTOMER_NUMBER" } },
    { name: "bank_number", dataType: "NUMBER(38,0)", nullable: true, businessMeaning: "Identifies the financial institution", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "BANK_NUMBER" }, piiClassification: "HIGH" },
    { name: "primary_phone_number", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "CUSTOMER's primary phone number", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "PRIMARY_PHONE_NUMBER" }, piiClassification: "HIGH" },
    { name: "secondary_phone_number", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "CUSTOMER's secondary phone number", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "SECONDARY_PHONE_NUMBER" }, piiClassification: "HIGH" },
    { name: "fax_phone_number", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "CUSTOMER's fax number", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "FAX_PHONE_NUMBER" }, piiClassification: "HIGH" },
    { name: "row_hash", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Hash value of Business Columns", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "MD5 hash" } },
    { name: "business_date", dataType: "DATE", nullable: true, businessMeaning: "Date when the record was created in business", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "BUSINESS_DATE" } },
    { name: "record_date", dataType: "DATE", nullable: true, businessMeaning: "Date when the record was Extracted", sourceMapping: { bronzeTable: "bronze.customer_names_addresses", bronzeColumn: "RECORD_DATE" } },
    { name: "effective_start_date", dataType: "DATE", nullable: true, businessMeaning: "Indicates date when record got Active", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "SCD Type 2 logic" } },
    { name: "effective_end_date", dataType: "DATE", nullable: true, businessMeaning: "Indicates date when record got Inactive", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "SCD Type 2 logic" } },
    { name: "record_flag", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "Indicates whether record is Active or Inactive", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "SCD Type 2 logic" } },
    { name: "insert_by", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "User ID used for the pipeline execution", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "System generated" } },
    { name: "insert_dt", dataType: "TIMESTAMP_NTZ(9)", nullable: true, businessMeaning: "Datetime when record is inserted", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "System generated" } },
    { name: "last_modified_by", dataType: "VARCHAR(16777216)", nullable: true, businessMeaning: "User ID used for the pipeline Modified", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "System generated" } },
    { name: "last_modified_dt", dataType: "TIMESTAMP_NTZ(9)", nullable: true, businessMeaning: "Datetime when record is last modified", sourceMapping: { bronzeTable: "N/A", bronzeColumn: "N/A", transformation: "System generated" } },
